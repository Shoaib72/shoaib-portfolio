...
const AboutMe = () => {
    return (
        <div className="bg-black shadow-xl absolute top-[100px] md:top-[200px] ml-[50px] md:ml-[300px] md:flex md:gap-[80px]">
            ...
            <div>
                ...
                <div className="bg-white py-2 rounded-lg flex gap-6 w-[125px]">
                    <a href="https://www.facebook.com/shoaibdacapo/"><FaFacebook size={25}></FaFacebook></a>
                    <a href="https://github.com/Shoaib72"><FaGithub size={25}></FaGithub></a>
                    <a href="https://www.linkedin.com/in/shoaib-ahammed/"><FaLinkedin size={25}></FaLinkedin></a>
                </div>
            </div>
        </div >
    );
