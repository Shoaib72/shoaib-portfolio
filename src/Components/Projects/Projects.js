...
const Projects = () => {
    return (
        <div>
            <h2 className="md:text-3xl text-2xl text-red-600 font-bold text-center absolute md:top-[150px] top-[70px] md:ml-[520px] ml-[120px]">MY
            ...
            <div className='absolute md:top-[200px] top-[120px] md:flex md:gap-[40px] gap-[22px] md:ml-[260px]'>
                <div className="card md:w-64 bg-black shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className='flex md:flex-col py-1'>
                            ...
                            <a className='border-2px border-red-600 bg-red-600 rounded-lg text-white p-1 font-bold w-[130px] md:mb-1' href="https://sky-hype-f2075.web.app/">GITHUB</a>
